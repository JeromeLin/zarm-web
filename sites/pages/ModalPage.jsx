    ...
    return (
      <div className="example">
        ...
        <Document
          ...
          demo={
            <div>
              <Button theme="info" onClick={() => this._onClickOpen('modal')}>
                Open Modal
              </Button>
              <Modal
              ...
              >
                <Modal.Header
                  title="普通模态框"
                  onClose={() => this._onClickClose('modal')}
                />
                <Modal.Body>
                  模态框内容<br />
                  模态框内容<br />
          ...
          code={`import { Modal } from 'dragon-ui';
          ...
          demo={
            <div>
              <div className="demo-inline">
                <Button onClick={() => this._onClickOpen('radiusModal')}>
                  Open Radius Modal
                </Button>
                <Button
                  theme="info"
                  onClick={() => this._onClickOpen('roundModal')}
                >
                  Open Round Modal
                </Button>
              </div>
              ...
              >
                <Modal.Header
                  title="圆角模态框"
                  onClose={() => this._onClickClose('radiusModal')}
                />
                <Modal.Body>
                  模态框内容<br />
                  模态框内容<br />
              ...
              >
                <Modal.Header
                  title="椭圆模态框"
                  onClose={() => this._onClickClose('roundModal')}
                />
                <Modal.Body>
                  模态框内容<br />
                  模态框内容<br />
        ...
        <Document
          ...
          demo={
            <div>
              <Button
                theme="info"
                onClick={() => this._onClickOpen('footerModal')}
              >
                Open Modal
              </Button>
              <Modal
              ...
              >
                ...
                <Modal.Footer>
                  <Button onClick={() => this._onClickClose('footerModal')}>
                    取消
                  </Button>
                  <Button
                    theme="info"
        ...
        <Document
          ...
          demo={
            <div>
              <Button
                theme="info"
                onClick={() => this._onClickOpen('widthModal')}
              >
                Open Modal
              </Button>
              <Modal
              ...
              >
                <Modal.Header
                  title="固定宽高的模态框"
                  onClose={() => this._onClickClose('widthModal')}
                />
        ...
        <Document
          ...
          demo={
            <div>
              <div className="demo-inline">
                <Button
                  onClick={() => this._onClickOpenAni('aniModal', 'fade')}
                >
                  Open Fade Modal
                </Button>
                <Button
                  onClick={() => this._onClickOpenAni('aniModal', 'zoom')}
                >
                  Open Zoom Modal
                </Button>
                <Button
                  onClick={() => this._onClickOpenAni('aniModal', 'door')}
                >
                  Open Door Modal
                </Button>
                <Button
                  onClick={() => this._onClickOpenAni('aniModal', 'flip')}
                >
                  Open Flip Modal
                </Button>
                <Button
                  onClick={() => this._onClickOpenAni('aniModal', 'rotate')}
                >
                  Open Rotate Modal
                </Button>
                <Button
                  onClick={() => this._onClickOpenAni('aniModal', 'slideUp')}
                >
                  Open SlideUp Modal
                </Button>
                <Button
                  onClick={() => this._onClickOpenAni('aniModal', 'slideDown')}
                >
                  Open SlideDown Modal
                </Button>
                <Button
                  onClick={() => this._onClickOpenAni('aniModal', 'slideLeft')}
                >
                  Open SlideLeft Modal
                </Button>
                <Button
                  onClick={() => this._onClickOpenAni('aniModal', 'slideRight')}
                >
              ...
              >
                <Modal.Header
                  title={this.state.aniType + ' 动画的模态框'}
                  onClose={() => this._onClickClose('aniModal')}
                />
                <Modal.Body>
                  模态框内容<br />
                  模态框内容<br />
                ...
                <Modal.Footer>
                  <Button onClick={() => this._onClickClose('aniModal')}>
                    取消
                  </Button>
                  <Button
                    theme="success"
