    ...
    return (
      <Loading visible={this.state.loading}>
        <div className="demo">
          ...
          <Form type="inline">
            <Form.Item className="col-sm-4" label="类型">
              <Input placeholder="请输入..." />
            </Form.Item>
            <Form.Item className="col-sm-4" label="来源">
              <Input placeholder="请输入..." />
            </Form.Item>
            <Form.Item className="col-sm-4" label="">
          ...
          <Form type="horizontal">
            ...
            >
              ...
              <Button>
                <Icon type="right" loading /> 带图标的按钮
              </Button>
            ...
            <Form.Item label="标签" labelCol="col-sm-2" controlCol="col-sm-10">
              <Tag size="xl" radius>
                特大号标签
              </Tag>
              <Tag size="lg" theme="info" radius>
                大号标签
              </Tag>
              <Tag theme="success" radius>
                普通标签
              </Tag>
              <Tag size="sm" theme="warning" radius>
                小号标签
              </Tag>
              <Tag size="xs" theme="error" radius>
                特小号标签
              </Tag>
              <br />
              {this.state.tags.map(tag => (
                <Tag
                  ...
                  size="xs"
                  radius
                  onClose={() => this._removeTag(tag.key)}
                >
                  {tag.name}
                </Tag>
              ))}
            ...
            >
              ...
              <br />
              <Switch
                isCheckedText={<Icon type="right" />}
                unCheckedText={<Icon type="wrong" />}
              />{' '}
              图标开关
              <br />
              <Switch
              ...
              <div style={{ verticalAlign: 'middle' }}>
                ...
                >
                  <Button
                    ...
                    onClick={() => {
                      const mulSelectLeft = [
                        ...this.state.mulSelectLeft
                      ].filter(
                        item =>
                          this.state.mulSelectLeftValue.indexOf(item.value) <
                            0 && item
                      );
                      let selected = [...this.state.mulSelectLeft].filter(
                        item =>
                          this.state.mulSelectLeftValue.indexOf(item.value) >
                            -1 && item
                      );
                      let mulSelectRight = this.state.mulSelectRight.concat(
                        selected
                      );
                      this.setState({
                        mulSelectLeft,
                  ...
                  <Button
                    ...
                    onClick={() => {
                      const mulSelectRight = [
                        ...this.state.mulSelectRight
                      ].filter(
                        item =>
                          this.state.mulSelectRightValue.indexOf(item.value) <
                            0 && item
                      );
                      let selected = [...this.state.mulSelectRight].filter(
                        item =>
                          this.state.mulSelectRightValue.indexOf(item.value) >
                            -1 && item
                      );
                      let mulSelectLeft = this.state.mulSelectLeft.concat(
                        selected
                      );
                      this.setState({
                        mulSelectLeft,
            ...
            <Form.Item label="日历" labelCol="col-sm-2" controlCol="col-sm-10">
              <Calendar
            ...
            <Form.Item label="上传" labelCol="col-sm-2" controlCol="col-sm-10">
              <Upload
              ...
              <Button
                isLoading={this.state.startUpload}
                isDisabled={this.state.startUpload}
                onClick={() => {
                  this.setState({
                    startUpload: true
                  });
              ...
              <Upload.List
                ...
                onDelete={item => {
                  let uploadDataSource = [
                    ...this.state.uploadDataSource
                  ].filter(file => file && file.id != item.id);
                  this.setState({ uploadDataSource });
                }}
              />
            </Form.Item>
            ...
            >
              ...
              <Button onClick={() => this._toggleModal('rotate')}>
                rotate
              </Button>
              <Button onClick={() => this._toggleModal('slideUp')}>
                slideUp
              </Button>
              <Button onClick={() => this._toggleModal('slideDown')}>
                slideDown
              </Button>
              <Button onClick={() => this._toggleModal('slideLeft')}>
                slideLeft
              </Button>
              <Button onClick={() => this._toggleModal('slideRight')}>
                slideRight
              </Button>
              <Button onClick={() => this._toggleModal('moveUp')}>
                moveUp
              </Button>
              <Button onClick={() => this._toggleModal('moveDown')}>
                moveDown
              </Button>
              <Button onClick={() => this._toggleModal('moveLeft')}>
                moveLeft
              </Button>
              <Button onClick={() => this._toggleModal('moveRight')}>
                moveRight
              </Button>
            </Form.Item>
            ...
            >
              ...
              <Button onClick={() => this._onClickOpen('confirm')}>
                确认框
              </Button>
              <Button onClick={() => this._onClickOpen('alert')}>警告框</Button>
              <Button onClick={() => this._onClickOpen('loading')}>
                加载中
              </Button>
              <Button
                onClick={() => this._showMessage('this is message.' + index++)}
              >
                消息提示
              </Button>
            </Form.Item>

            <Form.Item label="菜单" labelCol="col-sm-2" controlCol="col-sm-10">
            ...
            <Form.Item label="分页" labelCol="col-sm-2" controlCol="col-sm-10">
              <div>
                <Pagination
                  bordered
                  radius
            ...
            <Form.Item label="面板" labelCol="col-sm-2" controlCol="col-sm-10">
              <Panel radius>
                <Panel.Header>
                  <Panel.Title>头部左侧</Panel.Title>
                  <Panel.More>头部右侧</Panel.More>
                </Panel.Header>
                <Panel.Body>内容</Panel.Body>
                <Panel.Footer>
                  <Panel.Title>底部左侧</Panel.Title>
                  <Panel.More>底部右侧</Panel.More>
                </Panel.Footer>
              </Panel>
            </Form.Item>

            <Form.Item label labelCol="col-sm-2" controlCol="col-sm-10">
              <Button
                theme="info"
                onClick={() => {
                    ...
                    render: (value, row, index) => {
                      return (
                        <Select size="sm" value={value} style={{ width: 130 }}>
                          ...
                          <Select.Option value="健康险事业部">
                            健康险事业部
                          </Select.Option>
                          <Select.Option value="金融信保部">
                            金融信保部
                          </Select.Option>
                          <Select.Option value="人力资源部">
                            人力资源部
                          </Select.Option>
                        </Select>
                      );
