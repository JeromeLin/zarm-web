...
ReactDOM.render(
  <>
    ...
    <br />
    <Button theme="primary" shape="rect">
      rect
    </Button>
    <Button theme="primary" shape="radius">
      radius
    </Button>
    <Button theme="primary" shape="round">
      round
    </Button>
...
ReactDOM.render(
  <>
    ...
    <Button icon="time" theme="primary" size="md">
      primary
    </Button>
    <Button icon="keyboard" theme="danger" size="md">
      danger
    </Button>
    <br />
...
ReactDOM.render(
  <div className="rows-dark" style={{ paddingBottom: 0 }}>
    ...
    <Button ghost disabled theme="primary">
      禁用状态
    </Button>
...
使用 a 标签代替 button, 可设置 href, target 属性
...
ReactDOM.render(
  <>
    ...
    <Button href="https://www.baidu.com/" theme="default" target="_blank">
      default
    </Button>
    <Button href="https://www.baidu.com/" theme="danger" target="_blank">
      danger
    </Button>
    <Button href="https://www.baidu.com/" disabled theme="danger" target="_blank">
      danger
    </Button>
  </>,
  mountNode,
...
| icon     | string                                                                                   | ''        | 图标类型，设置 Icon 组件的 type                                  |
