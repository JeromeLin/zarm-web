...
const domUtil = {
    ...
    getOuterSizes: (e) => {
        const _display = e.style.display, _visibility = e.style.visibility;
        ...
        const result = { width: e.offsetWidth + y, height: e.offsetHeight + x };

        // reset
        e.style.display = _display; e.style.visibility = _visibility;
        return result;
	},
