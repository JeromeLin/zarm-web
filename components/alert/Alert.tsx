          ...
          visibility && (
            <div
              ...
              className={classnames(prefixCls, className, {
                ...
                [`${prefixCls}-no-with-description`]: !Boolean(description),
                [`${prefixCls}-sm-icon`]: showIcon && !Boolean(description),
                [`${prefixCls}-lg-icon`]: showIcon && Boolean(description),
                [`${prefixCls}-close-animation`]: closeStart
              })}
            >
              { showIcon && <AlertIcon { ...this.props }/> }
              { closable && <CloseIcon closable={ closable } closeText={ closeText } prefixCls={ prefixCls } handleClose={ this.handleClose } close={ this.close.bind(this) }/> }
