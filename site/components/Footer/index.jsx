    ...
    return (
      <footer>
        <div className="group">
          ...
          <ul>
            <li><a href="https://zarm.design" rel="noopener noreferrer" target="_blank">Zarm</a> - Zarm of React</li>
        ...
        <div className="group">
          ...
          <ul>
            <li><a href="https://github.com/JeromeLin/zarm-web" rel="noopener noreferrer" target="_blank">Github</a></li>
            <li>
            ...
            <li>
              <a href="https://github.com/JeromeLin/zarm-web/issues/new" rel="noopener noreferrer" target="_blank">
                <FormattedMessage id="app.home.footer.help.bug-report" />
              </a>
            </li>
            <li>
              <a href="https://github.com/JeromeLin/zarm-web/issues" rel="noopener noreferrer" target="_blank">
                <FormattedMessage id="app.home.footer.help.bug-list" />
              </a>
            </li>
            <li>
              <a href="https://gitter.im/ZhonganTech/zarm-web" rel="noopener noreferrer" target="_blank">
