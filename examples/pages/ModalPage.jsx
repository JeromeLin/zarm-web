...
import { Button, Modal, Confirm } from 'zarm';
  ...
  render() {
    return (
      <Container className="modal-page">
        ...
        <main>
          <Button onClick={() => this.open('modal1')}>开启</Button>
          <Button onClick={() => this.open('modal3')}>开启</Button>
          <Button onClick={() => this.open('modal2')}>开启</Button>
          <Button onClick={() => this.open('modal4')}>开启</Button>
          <Button onClick={() => this.open('modal5')}>开启</Button>
          <Button theme="warning" onClick={() => this.open('confirm')}>开启</Button>
